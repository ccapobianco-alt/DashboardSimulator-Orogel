...
def genera_meteo_anno(year: int) -> pd.DataFrame:
    rng = np.random.default_rng(year) # seed fisso per anno
...
def render_tabs(tab, view, cache):
    ...
    fig_ph.update_layout(title="pH del suolo vs. quantità mensile sulla resa annuale (%)", height=420, margin=dict(l=40,r=20,t=60,b=40))
